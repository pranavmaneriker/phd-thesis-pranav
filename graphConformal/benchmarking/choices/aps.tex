...
\begin{figure}
    ...
    \begin{subfigure}{0.7\linewidth}
        \centering
        \includegraphics[width=\linewidth,alt={Probability density plots showing the distribution of scores for randomized and non-randomized versions of APS.}]{graphConformal/figures/aps_dist}
    \end{subfigure}
    \begin{subfigure}{0.7\linewidth}
        \centering
        \includegraphics[width=\linewidth,alt={Line plot showing the scores for the incorrect class against the sorted index for the score.}]{graphConformal/figures/aps_sorted}
    \end{subfigure}
