...
We used dynamic masking~\cite{liu2019roberta}, i.e., different tokens masked from the same sequence across iterations.
 ...
 \todo{Potentially discuss covariate shift here?}
 
\textbf{Threat Model}
\todo{Consider rewording this seciton}
...
\todo{Maybe add the dynamic program algorithm here, and talk about the computational complexity?}
