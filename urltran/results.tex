...
Figure~\ref{fig:urltran:pretrain_scratch}\todo{Some figure font manipulation may be needed} demonstrates that the training is not very sensitive to sequence length. 
