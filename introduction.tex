...
Further, the study of grammars and their innateness in formal languages has also played a crucial role in the study of machine learning on natural language\todo{citation here}%~\cite{missing},
...
\todo{what makes style different from other issues in the llm continuum}\
...
\subsection{Interpretable Stylometric Modeling}
...
This is an active area of research with interest from organizations such as IARPA~(\citeyear{hiatus2022iarpa}).\todo{Does this statement add anything useful?}
