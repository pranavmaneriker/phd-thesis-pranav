...
\usepackage{amsthm,bbm,amsmath,amssymb,bm} % math packages
...
\usepackage{cleveref} % clevelr refs in AVOIR, must be loaded after hyperref
...
\newcommand{\avcomment}[1]{
    \sidenote{PM}{red!40}{}{#1}
}
\newcommand{\avComment}[1]{
    \sidenote{PM}{red!40}{inline}{#1}
}

\newcommand{\ascomment}[1]{
    \sidenote{PM}{orange!40}{}{#1}
}
\newcommand{\asComment}[1]{
    \sidenote{PM}{orange!40}{inline}{#1}
}